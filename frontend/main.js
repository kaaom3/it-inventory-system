...
window.updateDashboard = function(folderId) {
    ...
    const skipKeys = ['Staff', 'CustomMenus', 'TransactionHistory', 'LoanHistory', 'admins', 'Software']; const allItems = []; const locationCounts = {};
...
window.buildAssetsByUserPage = function() {
    ...
    container.innerHTML = '';
    const byUser = {};
    const skipKeys = ['Staff', 'CustomMenus', 'TransactionHistory', 'LoanHistory', 'admins', 'Software'];
