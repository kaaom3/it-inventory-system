...
const translations = {
    en: {
        ...
        move_info: "Loan history will be moved automatically.",
    ...
    th: {
        ...
        maintenance_management: "ศูนย์บริหารงานซ่อมบำรุง",
        ...
        add_new_log: "เพิ่มบันทึกงานซ่อม",
        description: "รายละเอียดงานซ่อม*",
        date_log: "วันที่ดำเนินการ*",
        cost: "ค่าใช้จ่าย (บาท)",
        technician: "ช่าง/ผู้รับผิดชอบ",
        status: "สถานะงาน",
        waiting_for_parts: "รออะไหล่",
        in_progress: "กำลังซ่อม",
        scheduled: "จองคิวซ่อม",
        save_log: "บันทึกข้อมูลการซ่อม",
        past_records: "ประวัติการซ่อมย้อนหลัง",
...
window.updateDashboard = function(folderId) {
    ...
    const skipKeys = ['Staff', 'CustomMenus', 'TransactionHistory', 'LoanHistory', 'admins', 'Software', 'Maintenance Log']; const allItems = []; const locationCounts = {};
...
window.buildAssetsByUserPage = function() {
    ...
    container.innerHTML = '';
    const byUser = {};
    const skipKeys = ['Staff', 'CustomMenus', 'TransactionHistory', 'LoanHistory', 'admins', 'Software', 'Maintenance Log'];
